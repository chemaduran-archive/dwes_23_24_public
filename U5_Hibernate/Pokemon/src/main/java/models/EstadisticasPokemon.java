...
//    private Long id;
    ...
    public boolean equals(Object o) {
        ...
        return Double.compare(peso, that.peso) == 0 && Double.compare(altura, that.altura) == 0 && ps == that.ps && ataque == that.ataque && defensa == that.defensa && at_especial == that.at_especial && df_especial == that.df_especial && velocidad == that.velocidad && Objects.equals(pokemon.getId(), that.pokemon.getId());
    }

    @Override
    public int hashCode() {
        return Objects.hash(pokemon.getId(), peso, altura, ps, ataque, defensa, at_especial, df_especial, velocidad);
    }
}
